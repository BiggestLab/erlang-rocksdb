...
static ErlNifFunc nif_funcs[] =
    {
        ...
        {"get_properties_of_tables_in_range", 3, erocksdb::GetPropertiesOfTablesInRange, ERL_NIF_DIRTY_JOB_IO_BOUND},
        ...
        {"sst_file_writer_close", 1, erocksdb::SstFileWriterClose, ERL_NIF_REGULAR_BOUND},
        ...
        {"iterator_move_n", 3, erocksdb::IteratorMoveN, ERL_NIF_DIRTY_JOB_IO_BOUND},
        {"iterator_move_key", 2, erocksdb::IteratorMoveKey, ERL_NIF_DIRTY_JOB_IO_BOUND},
        {"iterator_move_keys_n", 3, erocksdb::IteratorMoveKeysN, ERL_NIF_DIRTY_JOB_IO_BOUND},
...
ERL_NIF_TERM ATOM_BLC_SKIP;
ERL_NIF_TERM ATOM_BLC_IF_HAVE_COMPACTION_FILTER;
ERL_NIF_TERM ATOM_BLC_FORCE;
ERL_NIF_TERM ATOM_BLC_FORCE_OPTIMIZED;
...
ERL_NIF_TERM ATOM_BEING_COMPACTED;
ERL_NIF_TERM ATOM_NAME;
ERL_NIF_TERM ATOM_SIZE;
ERL_NIF_TERM ATOM_LEVELS;
ERL_NIF_TERM ATOM_FILES;
...
ERL_NIF_TERM ATOM_WRITE_GLOBAL_SEQNO;
ERL_NIF_TERM ATOM_VERIFY_CHECKSUMS_BEFORE_INGEST;
ERL_NIF_TERM ATOM_LISTENER;
ERL_NIF_TERM ATOM_ROCKSDB_EVENT;
ERL_NIF_TERM ATOM_FLUSH_BEGIN;
ERL_NIF_TERM ATOM_FLUSH_COMPLETED;
ERL_NIF_TERM ATOM_COMPACTION_BEGIN;
ERL_NIF_TERM ATOM_COMPACTION_COMPLETED;
ERL_NIF_TERM ATOM_MEMTABLE_SEALED;
ERL_NIF_TERM ATOM_STALL_CONDITIONS_CHANGED;
ERL_NIF_TERM ATOM_BACKGROUND_ERROR;
ERL_NIF_TERM ATOM_EXTERNAL_FILE_INGESTED;
ERL_NIF_TERM ATOM_TABLE_FILE_DELETED;
ERL_NIF_TERM ATOM_CF_NAME;
ERL_NIF_TERM ATOM_JOB_ID;
ERL_NIF_TERM ATOM_CUR;
ERL_NIF_TERM ATOM_STATUS;
ERL_NIF_TERM ATOM_NORMAL;
ERL_NIF_TERM ATOM_DELAYED;
ERL_NIF_TERM ATOM_STOPPED;
ERL_NIF_TERM ATOM_REASON;
ERL_NIF_TERM ATOM_FLUSH;
ERL_NIF_TERM ATOM_COMPACTION;
ERL_NIF_TERM ATOM_WRITE_CALLBACK;
ERL_NIF_TERM ATOM_MEMTABLE;
ERL_NIF_TERM ATOM_MANIFEST_WRITE;
ERL_NIF_TERM ATOM_FLUSH_NO_WAL;
ERL_NIF_TERM ATOM_MANIFEST_WRITE_NO_WAL;
ERL_NIF_TERM ATOM_TRIGGERED_WRITES_SLOWDOWN;
ERL_NIF_TERM ATOM_TRIGGERED_WRITES_STOP;
ERL_NIF_TERM ATOM_BASE_INPUT_LEVEL;
ERL_NIF_TERM ATOM_OUTPUT_LEVEL;
ERL_NIF_TERM ATOM_NUM_L0_FILES;
ERL_NIF_TERM ATOM_NUM_INPUT_RECORDS;
ERL_NIF_TERM ATOM_NUM_OUTPUT_RECORDS;
ERL_NIF_TERM ATOM_ELAPSED_MICROS;
ERL_NIF_TERM ATOM_EXTERNAL_FILE_PATH;
ERL_NIF_TERM ATOM_COMPACTION_FILTER;
ERL_NIF_TERM ATOM_COMPACT_ON_DELETION;
ERL_NIF_TERM ATOM_DROP_KEY_RANGE;
ERL_NIF_TERM ATOM_DROP_BELOW_DECIMAL;
...
#define ATOM(Id, Value) { Id = enif_make_atom(env, Value); }
  ...
  ATOM(erocksdb::ATOM_BLC_SKIP, "skip");
  ATOM(erocksdb::ATOM_BLC_IF_HAVE_COMPACTION_FILTER, "if_have_compaction_filter");
  ATOM(erocksdb::ATOM_BLC_FORCE, "force");
  ATOM(erocksdb::ATOM_BLC_FORCE_OPTIMIZED, "force_optimized");
  ...
  ATOM(erocksdb::ATOM_FILE_NAME,"file_name");
  ...
  ATOM(erocksdb::ATOM_BEING_COMPACTED,"being_compacted");
  ATOM(erocksdb::ATOM_NAME,"name");
  ATOM(erocksdb::ATOM_SIZE,"size");
  ATOM(erocksdb::ATOM_LEVELS,"levels");
  ATOM(erocksdb::ATOM_FILES,"files");
  ...
  ATOM(erocksdb::ATOM_WRITE_GLOBAL_SEQNO,"write_global_seqno");
  ATOM(erocksdb::ATOM_VERIFY_CHECKSUMS_BEFORE_INGEST,"verify_checksums_before_ingest");
  ATOM(erocksdb::ATOM_LISTENER,"listener");
  ATOM(erocksdb::ATOM_ROCKSDB_EVENT,"rocksdb_event");
  ATOM(erocksdb::ATOM_FLUSH_BEGIN,"flush_begin");
  ATOM(erocksdb::ATOM_FLUSH_COMPLETED,"flush_completed");
  ATOM(erocksdb::ATOM_COMPACTION_BEGIN,"compaction_begin");
  ATOM(erocksdb::ATOM_COMPACTION_COMPLETED,"compaction_completed");
  ATOM(erocksdb::ATOM_MEMTABLE_SEALED,"memtable_sealed");
  ATOM(erocksdb::ATOM_STALL_CONDITIONS_CHANGED,"stall_conditions_changed");
  ATOM(erocksdb::ATOM_BACKGROUND_ERROR,"background_error");
  ATOM(erocksdb::ATOM_EXTERNAL_FILE_INGESTED,"external_file_ingested");
  ATOM(erocksdb::ATOM_TABLE_FILE_DELETED,"table_file_deleted");
  ATOM(erocksdb::ATOM_CF_NAME,"cf_name");
  ATOM(erocksdb::ATOM_JOB_ID,"job_id");
  ATOM(erocksdb::ATOM_CUR,"cur");
  ATOM(erocksdb::ATOM_STATUS,"status");
  ATOM(erocksdb::ATOM_NORMAL,"normal");
  ATOM(erocksdb::ATOM_DELAYED,"delayed");
  ATOM(erocksdb::ATOM_STOPPED,"stopped");
  ATOM(erocksdb::ATOM_REASON,"reason");
  ATOM(erocksdb::ATOM_FLUSH,"flush");
  ATOM(erocksdb::ATOM_COMPACTION,"compaction");
  ATOM(erocksdb::ATOM_WRITE_CALLBACK,"write_callback");
  ATOM(erocksdb::ATOM_MEMTABLE,"memtable");
  ATOM(erocksdb::ATOM_MANIFEST_WRITE,"manifest_write");
  ATOM(erocksdb::ATOM_FLUSH_NO_WAL,"flush_no_wal");
  ATOM(erocksdb::ATOM_MANIFEST_WRITE_NO_WAL,"manifest_write_no_wal");
  ATOM(erocksdb::ATOM_TRIGGERED_WRITES_SLOWDOWN,"triggered_writes_slowdown");
  ATOM(erocksdb::ATOM_TRIGGERED_WRITES_STOP,"triggered_writes_stop");
  ATOM(erocksdb::ATOM_BASE_INPUT_LEVEL,"base_input_level");
  ATOM(erocksdb::ATOM_OUTPUT_LEVEL,"output_level");
  ATOM(erocksdb::ATOM_NUM_L0_FILES,"num_l0_files");
  ATOM(erocksdb::ATOM_NUM_INPUT_RECORDS,"num_input_records");
  ATOM(erocksdb::ATOM_NUM_OUTPUT_RECORDS,"num_output_records");
  ATOM(erocksdb::ATOM_ELAPSED_MICROS,"elapsed_micros");
  ATOM(erocksdb::ATOM_EXTERNAL_FILE_PATH,"external_file_path");
  ATOM(erocksdb::ATOM_COMPACTION_FILTER,"compaction_filter");
  ATOM(erocksdb::ATOM_COMPACT_ON_DELETION,"compact_on_deletion");
  ATOM(erocksdb::ATOM_DROP_KEY_RANGE,"drop_key_range");
  ATOM(erocksdb::ATOM_DROP_BELOW_DECIMAL,"drop_below_decimal");
